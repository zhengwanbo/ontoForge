  ...
  <div class="graph-query-page">
    ...
    <el-card shadow="never" class="query-card">
      <div class="query-form">
        ...
        <el-input-number v-model="rowLimit" class="row-limit-input" :min="1" :max="1000" controls-position="right" />
        <div class="query-actions"><el-button type="primary" :loading="generatingRecommendations" :disabled="!domainId || !sourceId" @click="generateRecommendations"><el-icon><MagicStick /></el-icon>生成场景与 SQL</el-button><el-button type="primary" :loading="executing" :disabled="!canExecute" @click="executeQuery">执行 Graph SQL</el-button></div>
      </div>
